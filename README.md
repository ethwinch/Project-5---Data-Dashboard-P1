# Web Development Project 5 - Weather Data Dashboard

Submitted by: Ethan Winch

This web app uses the Weatherbit API to allow users to search for a city. That city's weather data is then displayed. 
